...
[https://azizabada10.github.io/To_do/](https://azizabada10.github.io/To_do/)
...
Après soumission, la tâche est ajoutée à `ListesTaches` et sauvegardée dans `localStorage` :
...
* Les colonnes changent selon la taille : `col-span-10 md:col-span-2`.
